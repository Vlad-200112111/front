...
import ScheduleCall from "../Home/Schedule/ScheduleCall/ScheduleCall";
        ...
        <>
            <div
                style={{
                    ...
                    backgroundSize: '1065px'
                }}
            ></div>
            <Typography align={'left'} style={{marginTop:'12rem'}} className={classesMain.Text} variant={'h4'}>Личный кабинет</Typography>
            <Typography align={'left'} className={classesMain.Text} variant={'h5'}>Вся необходимая информация в одном месте!</Typography>
                        ...
                        <Box>
                            ...
                            <Box style={{
                                ...
                                >
                                    ...
                                    <Grid item xs={2}>
                                        <IconButton
                                            style={{background: 'rgb(255 152 69)', color: '#fff', float: 'right'}}
                                            aria-label="close"
                                            color="inherit"
                                            size="small"
                                            onClick={nextSteps}
