...
function Documents(props) {
    ...
    const [countDocumentOnCheck, setCountDocumentOnCheck] = useState(6)
    ...
    useEffect(async () => {
        ...
        const {data: CountOnCheck} = await api.documents.getCountDocumentForEmployer()
    ...
    useEffect(async () => {
        setLoadingDocuments(true)
        const {data: ListDocumentsForEmployee} = await api.documents.getListDocumentsFromEmployer(pageOnCheck, countDocumentOnCheck)
    ...
    const [TabList, setTabList] = useState([
        ...
        {id: '2', categoryName: 'Справки на проверку'},
    ])
                                                                                    ...
                                                                                    <>
                                                                                        {
                                                                                            listDocumentsForEmployee?.map((itemDocumentsForEmployee, index) =>
                                                                                                <ItemDocumentsGrid
                                                                                                    ...
                                                                                                    itemDocuments={itemDocumentsForEmployee}
                                                                                                    role={role}/>
                                                                                            )
                                                                                        }
                                                                                    </>
